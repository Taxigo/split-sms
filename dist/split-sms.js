...
var gsmAcceptedChars = '@£$¥èéùìòÇ\nØø\rÅåΔ_ΦΓΛΩΠΨΣΘΞÆæßÉ\x20!"#¤%&\'()*+,-./0123456789:;<=>?¡ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÑÜ§¿abcdefghijklmnopqrstuvwxyzäöñüà\f^{}\\[~]|€';
var gsmExtendedChars = '\f|^€{}[~]\\';

module.exports = function getValidator(options) {
  options = options || {};
  var extendedCharCodes = getCodePoints(options.extendedChars || gsmExtendedChars);
  var acceptedCharCodes = getCodePoints(options.acceptedChars || gsmAcceptedChars).concat(extendedCharCodes);
...
var genericValidator = require('./generic-validator');
var gsmDefaultCharacterSet = require('./gsm-default-character-set');
module.exports = [{
  shiftTableUdh: [],
...
function shiftTable(shiftTable, isLockingShift) {
  return [isLockingShift ? 0x25 : 0x24, 0x01, shiftTable];
}

},{"./generic-validator":1,"./gsm-default-character-set":2}],4:[function(require,module,exports){
'use strict';
...
module.exports.split = function (message, options) {
  ...
  if (fitsOneMessage()) {
    return {
      parts: [{
        content: options.summary ? undefined : options.buffer ? Buffer.concat([messages[0].content, messages[1].content]) : encodeGsm(messages[0].content + messages[1].content, options.encoding),
        length: totalLength,
        bytes: totalBytes
      }],
      encoding: options.encoding,
    ...
    if (str === undefined) {
      ...
      for (var i = 0; i < str.length; i++) {
        ...
        if (gsmChar === undefined) {
          var extendedChar = options.encoding.extendedChars[str[i]];
          if (extendedChar) {
  ...
  function singleUdhLength() {
    return options.encoding.shiftTableUdh.length === 0 ? 0 : 1 + (options.encoding.shiftTableUdh.length || 0);
  }
};
...
var gsmEncodings = require('./gsm-encodings');
...
module.exports.split = function (message, options) {
  ...
  if (isGsm && typeof options.encoding === 'undefined') {
    options.encoding = gsmEncodings[0];
  }
...
},{"./gsm-encodings":3,"./gsmsplitter":4,"./unicodesplitter":6}],6:[function(require,module,exports){
'use strict';
...
module.exports.split = function (message, options) {
  ...
  if (message === '') {
    return {
      parts: [{
        content: options.summary ? undefined : options.buffer ? iconv.encode('', 'utf16-be') : '',
        length: 0,
        bytes: 0
      }],
      totalLength: 0,
  ...
  function bank(partEnd) {
    var content = partEnd ? message.substring(partStart, partEnd + 1) : message.substring(partStart);
    var msg = {
      content: options.summary ? undefined : options.buffer ? iconv.encode(content, 'utf16-be') : content,
      length: length,
      bytes: bytes
    };
    messages.push(msg);
...
},{"iconv-lite":26}],7:[function(require,module,exports){
(function (Buffer){
"use strict"
...
},{"buffer":undefined,"string_decoder":undefined}],11:[function(require,module,exports){
(function (Buffer){
"use strict"
...
},{"buffer":undefined}],23:[function(require,module,exports){
(function (Buffer){
"use strict"
...
},{"buffer":undefined,"stream":undefined}],26:[function(require,module,exports){
...
},{"../encodings":9,"./bom-handling":24,"./extend-node":25,"./streams":27,"_process":undefined,"buffer":undefined}],27:[function(require,module,exports){
(function (Buffer){
"use strict"
...
},{"buffer":undefined,"stream":undefined}]},{},[5])(5)
});